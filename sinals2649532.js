...
fbq.registerPlugin("264953209769266", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        config.set("264953209769266", "inferredEvents", {
            "buttonSelector": null,
            "disableRestrictedData": false
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("264953209769266", "InferredEvents", true);
        config.set("264953209769266", "automaticMatching", {
            "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st", "country", "db", "external_id"]
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("264953209769266", "AutomaticMatching", true);
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("264953209769266", "IWLBootstrapper", true);
        config.set("264953209769266", "cookie", {
            "fbcParamsConfig": {
                "params": [{
                    "prefix": "",
                    "query": "fbclid",
        ...
        instance.optIn("264953209769266", "FirstPartyCookies", true);
        fbq.loadPlugin("inferredevents");
        instance.optIn("264953209769266", "InferredEvents", true);
        fbq.loadPlugin("automaticmatchingforpartnerintegrations");
        instance.optIn("264953209769266", "AutomaticMatchingForPartnerIntegrations", true);
        ...
        config.set("264953209769266", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("264953209769266", "ProhibitedSources", true);
        config.set("264953209769266", "unwantedData", {
            "blacklisted_keys": {
                "PageView": {
                    "cd": ["ac"],
                    "url": []
        ...
        instance.optIn("264953209769266", "UnwantedData", true);
        config.set("264953209769266", "IABPCMAEBridge", {
            "enableAutoEventId": true
        });
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("264953209769266", "IABPCMAEBridge", true);
        config.set("264953209769266", "browserProperties", {
            "delayInMs": 200,
        ...
        instance.optIn("264953209769266", "BrowserProperties", true);
        config.set("264953209769266", "eventValidation", {
            "unverifiedEventNames": [],
            "restrictedEventNames": []
        });
        fbq.loadPlugin("eventvalidation");
        instance.optIn("264953209769266", "EventValidation", true);
        config.set("264953209769266", "clientHint", {
            "delayInMs": 200,
            "disableBackupTimeout": false
        });
        fbq.loadPlugin("clienthint");
        instance.optIn("264953209769266", "ClientHint", true);
        fbq.loadPlugin("lastexternalreferrer");
        instance.optIn("264953209769266", "LastExternalReferrer", true);
        fbq.loadPlugin("cookiedeprecationlabel");
        instance.optIn("264953209769266", "CookieDeprecationLabel", true);
        fbq.loadPlugin("unwantedparams");
        instance.optIn("264953209769266", "UnwantedParams", true);
        instance.optIn("264953209769266", "ShadowTest", true);
        fbq.loadPlugin("standardparamchecks");
        instance.optIn("264953209769266", "StandardParamChecks", true);
        config.set("264953209769266", "actionID", {
            "portNumber": 12387,
            "ttlInHour": 2160
        });
        fbq.loadPlugin("actionid");
        instance.optIn("264953209769266", "ActionID", true);
        config.set("264953209769266", "gating", {
            "gatings": [{
        ...
        instance.optIn("264953209769266", "Gating", true);
        instance.configLoaded("264953209769266");
    }
});
